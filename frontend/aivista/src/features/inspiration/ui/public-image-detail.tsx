...
export function PublicImageDetail({ image, onClose, onImageChange, navigation }: { image: GenerationAsset; onClose: () => void; onImageChange: (image: GenerationAsset) => void; navigation?: ImageDetailNavigation }) {
