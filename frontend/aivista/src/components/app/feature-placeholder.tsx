...
export function GeneratePlaceholder() {
  return (
    <section className="mx-auto flex min-h-screen max-w-4xl items-center px-6 py-16">
      <div className="w-full rounded-[2rem] border border-border bg-card p-8 shadow-[0_24px_80px_-60px_rgba(15,23,42,0.42)] sm:p-12">
  ...
  return (
    <section className="mx-auto flex min-h-screen max-w-4xl items-center px-6 py-16">
      <div className="w-full rounded-[2rem] border border-border bg-card p-8 shadow-[0_24px_80px_-60px_rgba(15,23,42,0.42)] sm:p-12">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight">你的创作会在这里沉淀。</h1>
        <p className="mt-4 max-w-xl leading-7 text-muted-foreground">
